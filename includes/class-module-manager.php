...
class Module_Manager {
	...
	private function register_modules() {
		$this->modules = array(
			...
			'quick-view'            => array(
				'title'       => __( 'Quick View', 'store-kit' ),
				'description' => __( 'Let shoppers preview product details in a modal without leaving the shop page.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => true,
				'default'     => false,
			),
			'cart-notices'          => array(
				'title'       => __( 'Cart Notices', 'store-kit' ),
				'description' => __( 'Show targeted messages in the cart — upsell thresholds, free shipping progress bars, limited-time alerts.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => false,
				'default'     => false,
			),
			'checkout-field-editor' => array(
				'title'       => __( 'Checkout Field Editor', 'store-kit' ),
				'description' => __( 'Add, remove, reorder, or customise every WooCommerce checkout field without code.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => true,
				'default'     => false,
			),
			'custom-order-statuses' => array(
				'title'       => __( 'Custom Order Statuses', 'store-kit' ),
				'description' => __( 'Create custom order statuses beyond WooCommerce defaults with colours, icons, and email triggers.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => true,
				'default'     => false,
			),
			'stock-manager'         => array(
				'title'       => __( 'Stock Manager', 'store-kit' ),
				'description' => __( 'Inline bulk stock editing from a single screen.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => true,
				'default'     => false,
			),
			'product-tab-manager'   => array(
				'title'       => __( 'Product Tab Manager', 'store-kit' ),
				'description' => __( 'Add, remove, and reorder product page tabs with custom content.', 'store-kit' ),
				'tier'        => 'core',
				'enabled'     => true,
				'default'     => false,
			),
